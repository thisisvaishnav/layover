...
## Summary
- 378 nodes · 676 edges · 24 communities (14 shown, 9 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `400e69f4`
...
Cohesion: 0.15
Nodes (26): MinimapHUD, MinimapHUDProps, CAMERA_VIEW_CONFIG, CarSpec, computeCarPosition(), DAYLIGHT_CONFIG, EXPANDED_WORLD_BOUNDS, ROAD_SYSTEM_CONFIG (+18 more)

### Community 1 - "store.ts"
Cohesion: 0.12
Nodes (27): PlayGameContent(), FeedbackModal(), ObjectivesHUD(), OrderReceipt(), TranscriptHUD(), Header(), HeaderProps, VoiceControls() (+19 more)
...
Cohesion: 0.08
Nodes (33): Cafe3DWorld(), Cafe3DWorldProps, HotspotPrompt(), HotspotPromptProps, MinimapHUDHandle, VocabularyModalProps, AvatarKinematics, computeAvatarKinematics() (+25 more)

### Community 6 - "voice-agent/types.ts"
Cohesion: 0.07
Nodes (29): AudioQueuePlayer, base64ToInt16(), calculateRms(), float32ToInt16(), int16ToBase64(), int16ToFloat32(), resampleAudio(), TARGET_SAMPLE_RATE (+21 more)
...
## Knowledge Gaps
- **132 isolated node(s):** `MinimapHUDProps`, `CafeSceneHooks`, `BusStopFacility`, `ApartmentTowerFacility`, `HumanKinematics` (+127 more)
...
- **What connects `MinimapHUDProps`, `CafeSceneHooks`, `BusStopFacility` to the rest of the system?**
